...
| Associated website / domain | https://github.com/Bihzeh/maeve |
...
Maeve is a third-party launcher and client for Minecraft: Java Edition, in the same
...
Maeve is built to be safe and compliant. Microsoft and Minecraft access/refresh tokens
are handled entirely on the user's own machine and stored encrypted in the operating
system's credential store; they are never transmitted to or stored on any Maeve server.
