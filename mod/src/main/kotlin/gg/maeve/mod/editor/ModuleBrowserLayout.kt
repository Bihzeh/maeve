...
object ModuleBrowserLayout {
    ...
    fun modulesButton(screenW: Int): Rect = Rect((screenW - MODULES_W) / 2, BAR_Y, MODULES_W, BAR_H)
    fun doneButton(screenW: Int): Rect = Rect(screenW - DONE_W - 6, BAR_Y, DONE_W, BAR_H)
