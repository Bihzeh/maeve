...
/**
 * Drives the in-game mod menu: lists modules and toggles them. Screen rendering is bound
 * through the platform bridge; this controller holds the menu's behavior so it stays testable.
 */
class ModMenuController(val modules: ModuleManager) {
