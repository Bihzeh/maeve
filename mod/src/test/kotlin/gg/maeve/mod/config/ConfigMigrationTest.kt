...
class ConfigMigrationTest {
    @Test fun `v1 x y migrates to top-left offset and default style`() {
        val dir = Files.createTempDirectory("maeve-v1")
    ...
    @Test fun `v2 anchor offset and style round-trip`() {
        val dir = Files.createTempDirectory("maeve-v2")
    ...
    @Test fun `scale is clamped on load`() {
        val dir = Files.createTempDirectory("maeve-clamp")
    ...
    @Test fun `unknown keys still load`() {
        val dir = Files.createTempDirectory("maeve-unknown")
